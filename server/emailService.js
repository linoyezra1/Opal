...
/**
 * Static PDF attachments (גילוי נאות, כתב שירות) are loaded in `index.js` from
 * `server/assets/docs/` or `server/assets/DOC/` (see repoAssets.js). This module only forwards
 * `payload.attachments` to Resend.
 */
