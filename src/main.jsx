...
import OrgCentralizedEmployeeRegister from './pages/OrgCentralizedEmployeeRegister.jsx';
  ...
  <React.StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/org-employee-register" element={<OrgCentralizedEmployeeRegister />} />
