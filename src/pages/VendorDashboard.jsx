          ...
          {productLinks.map((line, idx) => (
            <div key={idx} className="grid grid-cols-1 md:grid-cols-12 gap-2 items-end border rounded-lg p-3 bg-slate-50">
              <div className="md:col-span-5">
                ...
                <select className="w-full border rounded-lg px-3 py-2 bg-white" value={line.productId} onChange={(e) => onProductSelect(idx, e.target.value)}>
              ...
              <div className="md:col-span-3">
                ...
                <input type="number" min="0" step="0.01" className="w-full border rounded-lg px-3 py-2" value={line.vendorCost} onChange={(e) => updateLink(idx, 'vendorCost', e.target.value)} />
              </div>
